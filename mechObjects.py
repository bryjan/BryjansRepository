...
godHelm= C.Helm( "God Helm", 5, 25,[radarDetector], 100, 15, 600, desc = "Dev Tool")
godHull= C.Hull( "God Hull", 5, 25, [], 150, 40, 250, 2, desc = "Dev Tool")
kikiLegs= C.Legs( "God Legs", 5, 25, [exosuitLegMotor, lightWeightFrame], 100, desc = "Dev Tool")
#MechClasses
